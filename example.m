...
% magnitudes = cell(1, numel(mcus));
% for i = 1:numel(mcus)
%     magnitudes{i} = zeros(1, 64);
% end
% 
% for i = 1:numel(mcus)
%     mcu = mcus{i};
...
%     end
%     magnitudes{i} = [dcMagnitude, acMagnitudes];
% end
% 
% % % differential encoding of DC values
% % for i = 1:numel(magnitudes)
% %     if i==1
% %         magnitudes{i}(1) = 0 + magnitudes{i}(1);
% %     else
% %         magnitudes{i}(1) = magnitudes{i-1}(1) + magnitudes{i}(1);
% %     end
% % end
% 
% % quality factor
...
% spatials = cell(1, numel(magnitudes));
% for i = 1:numel(magnitudes)
...
%     spatials{i} = idct2(zigzagQuant) + 128;
% end
